...
<div class="h-[500px] overflow-hidden  border-2 shadow w-full rounded-lg hover:outline-none hover:ring-2 hover:ring-blue-800 hover:border-blue-800 transition duration-300 ease-in-out">
