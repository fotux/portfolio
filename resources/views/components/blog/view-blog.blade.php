...
<x-index.layout color="black">
    ...
    <div class="md:max-w-4xl md:mx-auto md:my-10" x-data="blogSlider()">
        ...
        <div class="p-2 md:p-0 md:aspect-3/2 relative rounded-2xl overflow-hidden">
            <img class="h-full w-full object-contain" :src="`{{ asset('storage/') }}/${images[index].image_path}`"
                alt="blogo paveikslėlis">
            <button @click="prev"
                class="font-extrabold absolute right-4 md:right-4 top-1/2 transform -translate-y-1/2 translate-x-1/2 border-2 px-1  bg-black text-white rounded-full border-blue-800">→</button>
            <button @click="next"
