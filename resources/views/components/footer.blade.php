<footer class="bg-black text-white w-full lg:py-4">
    ...
    <div class="text-start">
        ...
        <div class="flex flex-col text-gray-300">
            <a class="text-xs md:text-sm" href="/kontaktai">Kontaktai</a>
        <a class="text-xs md:text-sm" href="/blog">Blogas</a>
        <a class="text-xs md:text-sm" href="/kainoraštis">Kainoraštis</a>
    ...
    <div>
        ...
        <a class="w-4 lg:w-6" href="https://www.instagram.com/dermicare_monikapetraityte/"><img src="{{ asset('images/instagram-white-icon.svg') }}" alt="Instagram"></a>
        <a class="w-4 lg:w-6" href="https://www.facebook.com/monika.petraityte.58"><img  src="{{ asset('images/facebook-round-color-icon.svg') }}" alt="Facebook"></a>
        </div>
    </div>
    </section>
</footer>
