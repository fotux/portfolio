<section class="lg:grid lg:grid-cols-3 lg:max-w-5xl lg:mx-auto"
         x-data="{
        currentIndex: 0,
           descriptions: [
                    {
    ...
    <div class="lg:col-span-1 ">
            <div class="p-4">
            <h1 class="text-lg font-semibold lg:mt-10 font-serif text-blue-800" x-text=descriptions[currentIndex].title ></h1>
