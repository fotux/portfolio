<x-layout color="black">
    ...
    <form method="POST" action="/komentaras/create" class="flex justify-center  ">
        @csrf
        ...
        @enderror
          ...
          <div class="border-b-2 border-blue-800 pb-4" x-data="{ rating: 0, hover: 0 }">
            <label class="block text-lg font-semibold text-gray-700 mb-2"  for="Name">Vertinimas</label>
